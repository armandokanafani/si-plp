...
@section('content')
<form action="{{ route('process.pendataan.edit', $data_pendataan->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="nama" type="text" class="form-control" name="nama" value="{{ $data_pendataan->nama }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="nim" type="text" class="form-control" name="nim" value="{{ $data_pendataan->nim }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="status_koordinator" required="" aria-readonly="true">
                                <optgroup label="Data Saat Ini">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="status_pamong" required="" aria-readonly="">
                                <optgroup label="Data Saat Ini">
                    ...
                    <a href="{{route('show.pendataan.admin')}}" class="btn btn-light pull-right">Back</a>
                </div>
              </div>
            </div>
          </div>
