...
@section('content')
<form action="{{ route('process.pendataan.pamong', $data_pendataan->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <select class="form-control" name="sekolah" required="" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <select class="form-control" name="peminatan" required="" disabled>
                                <optgroup label="Data Saat Ini">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="dospem" type="text" class="form-control" name="dospem" value="{{ $data_pendataan->dospem }}" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="pamong" type="text" class="form-control" name="pamong" value="{{ $data_pendataan->pamong }}" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <select class="form-control" name="status_koordinator" required=""disabled>
                                <optgroup label="Data Saat Ini">
                    ...
                    <a href="{{route('show.pendataan.pamong')}}" class="btn btn-light pull-right">Back</a>
                </div>
              </div>
            </div>
          </div>
